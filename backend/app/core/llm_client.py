...
PRD Referans: Bölüm 11 — LLM Entegrasyonu
"""
...
# =========================================================================
# GROQ İSTEMCİSİ
# PRD kararı: Birincil sağlayıcı, geliştirme ve demo için.
# =========================================================================
...
# =========================================================================
# GEMINI İSTEMCİSİ
# PRD kararı: Alternatif, büyük dokümanlar ve 1M context için.
# =========================================================================
...
def create_llm_client(
    ...
    match provider.lower():
        ...
        case _:
            raise ValueError(
                f"Desteklenmeyen LLM sağlayıcı: {provider}. "
                "Desteklenen: 'groq', 'google'"
            )
